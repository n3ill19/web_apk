...
<div style="width:90%; margin: 2em auto;">
    <a href="<?php print(_APP_ROOT); ?>ochrona_dostepu/app/security/logout.php" class="pure-button pure-button-active">Wyloguj</a>
</div>

<div style="width:90%; margin: 2em auto;">

<form action="<?php print(_APP_URL);?>ochrona_dostepu/app/calc.php" class="pure-form pure-form-stacked">
